...
class TestScreen extends Screen 
{
    ...
    public TestScreen(Game game) 
    {
        ...
        try 
        {
            ...
            Log.d("SquirellFrenzy", text + ", " + text2 );
        } 
        catch(Exception ex) 
        {
            ex.printStackTrace();
    ...
    public void present(float deltaTime) 
    {
        ...
        for(int i = 0; i < len; i++) 
        {
            Log.d("SquirellFrenzy", keyEvents.get(i).toString());
        }
        ...
        for(int i = 0; i < len; i++) 
        {
            Log.d("SquirellFrenzy", touchEvents.get(i).toString());
        ...
        {
            Log.d("SquirellFrenzy", "fps: " + frames + ", delta: " + deltaTime);
            frames = 0;
    ...
    public void pause() 
    {
        Log.d("SquirellFrenzy", "pause");                
    }

    @Override
    public void resume() 
    {
        Log.d("SquirellFrenzy", "resume");   
    }

    @Override
    public void dispose() 
    {
        Log.d("SquirellFrenzy", "dispose");
        music.dispose();
    }            
}
